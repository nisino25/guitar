...
ActiveRecord::Schema.define(version: 2020_06_21_103240) do
  ...
  create_table "add_countnum_to_users", force: :cascade do |t|
  end

  create_table "add_countnumber_to_users", force: :cascade do |t|
  end
